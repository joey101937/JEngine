...
//            try{
//                background = Graphic.scaleImageDirect(
//                    hostGame.getBackgroundImage().getCurrentImage(),
...
//            try {
//                background = Graphic.scaleImageDirect(hostGame.getBackgroundImage().getCurrentImage(),
//                        (xScale=(double)d.width / hostGame.getWorldWidth()),
//                        (yScale=(double)d.height / hostGame.getWorldHeight()));
//            } catch (Exception e) {
//                e.printStackTrace();
