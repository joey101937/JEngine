...
public class Bush2 extends GameObject2 implements SceneryObject {
    private static final long serialVersionUID = 1L;

    public static final Sprite bodySprite   = new Sprite(RTSAssetManager.bush2);
    public static final Sprite shadowSprite = Sprite.generateShadowSprite(RTSAssetManager.bush2, .8);
    ...
    public Bush2(int x, int y, int rotation) {
        super(x, y);
        this.setScale(VISUAL_SCALE);
        this.setGraphic(bodySprite);
        this.setZLayer(-1);
    ...
    public void render(Graphics2D g) {
        ...
        g.drawImage(shadowImg, renderLoc.x - 5 - shadowImg.getWidth() / 2, renderLoc.y + 10 - shadowImg.getHeight() / 2, null);
        g.setTransform(old);
