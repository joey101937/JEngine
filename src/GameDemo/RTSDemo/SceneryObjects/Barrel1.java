...
public class Barrel1 extends GameObject2 implements SceneryObject {
    private static final long serialVersionUID = 1L;

    public static final Sprite bodySprite   = new Sprite(RTSAssetManager.barrel1);
    public static final Sprite shadowSprite = Sprite.generateShadowSprite(RTSAssetManager.barrel1, .7);
    ...
    public Barrel1(int x, int y, int rotation) {
        super(x, y);
        this.setScale(VISUAL_SCALE);
        this.setGraphic(bodySprite);
        this.isSolid = true;
