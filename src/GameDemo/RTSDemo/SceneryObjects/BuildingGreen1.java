...
public class BuildingGreen1 extends GameObject2 implements SceneryObject, SightBlocker, MinimapRenderable {
    private static final long serialVersionUID = 1L;

    public static final Sprite bodySprite = new Sprite(RTSAssetManager.buildingGreen1);
    public static final Sprite shadowSprite = Sprite.generateShadowSprite(bodySprite.getImage(), .6);
    public static final Sprite extrasSprite = new Sprite(RTSAssetManager.buildingGreen1Extras);
    public static final double VISUAL_SCALE = 1.2;
    ...
    public BuildingGreen1(int x, int y) {
        super(x, y);
