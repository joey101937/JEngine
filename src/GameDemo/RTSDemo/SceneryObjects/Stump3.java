...
public class Stump3 extends GameObject2 implements SceneryObject {
    private static final long serialVersionUID = 1L;

    public static final Sprite bodySprite   = new Sprite(RTSAssetManager.stump3);
    public static final Sprite shadowSprite = Sprite.generateShadowSprite(RTSAssetManager.stump3, .7);
    ...
    public Stump3(int x, int y, int rotation) {
        super(x, y);
        this.setScale(VISUAL_SCALE);
        this.setGraphic(bodySprite);
        this.isSolid = true;
