...
public class Bush3 extends GameObject2 implements SceneryObject {
    private static final long serialVersionUID = 1L;

    public static final Sprite bodySprite   = new Sprite(RTSAssetManager.bush3);
    public static final Sprite shadowSprite = Sprite.generateShadowSprite(RTSAssetManager.bush3, .8);
    ...
    public Bush3(int x, int y, int rotation) {
        super(x, y);
        this.setScale(VISUAL_SCALE);
        this.setGraphic(bodySprite);
        this.setZLayer(-1);
