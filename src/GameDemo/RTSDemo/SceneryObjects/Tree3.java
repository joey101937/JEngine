...
public class Tree3 extends GameObject2 implements SceneryObject, SightBlocker {
    private static final long serialVersionUID = 1L;

    public static final Sprite bodySprite   = new Sprite(RTSAssetManager.tree3);
    public static final Sprite shadowSprite = new Sprite(RTSAssetManager.tree3Shadow);
    ...
    public Tree3(int x, int y, int rotation) {
        super(x, y);
        this.setScale(VISUAL_SCALE);
        this.setGraphic(bodySprite);
        this.isSolid = true;
