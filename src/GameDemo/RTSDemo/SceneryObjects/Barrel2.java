...
public class Barrel2 extends GameObject2 implements SceneryObject {
    private static final long serialVersionUID = 1L;

    public static final Sprite bodySprite   = new Sprite(RTSAssetManager.barrel2);
    public static final Sprite shadowSprite = Sprite.generateShadowSprite(RTSAssetManager.barrel2, .7);
    ...
    public Barrel2(int x, int y, int rotation) {
        super(x, y);
        this.setScale(VISUAL_SCALE);
        this.setGraphic(bodySprite);
        this.isSolid = true;
