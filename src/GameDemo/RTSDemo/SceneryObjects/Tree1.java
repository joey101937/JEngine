...
public class Tree1 extends GameObject2 implements SceneryObject, SightBlocker {
    private static final long serialVersionUID = 1L;

    public static final Sprite bodySprite   = new Sprite(RTSAssetManager.tree1);
    public static final Sprite shadowSprite = new Sprite(RTSAssetManager.tree1Shadow);
    ...
    static {
        ...
        shadowSprite.setOpacity(.9); // this shadow sprite is already partially transparent
    }
    ...
    public Tree1(int x, int y, int rotation) {
        super(x, y);
        this.setScale(VISUAL_SCALE);
        this.setGraphic(bodySprite);
        this.isSolid = true;
