...
public class Bush1 extends GameObject2 implements SceneryObject {
    private static final long serialVersionUID = 1L;

    public static final Sprite bodySprite   = new Sprite(RTSAssetManager.bush1);
    public static final Sprite shadowSprite = Sprite.generateShadowSprite(RTSAssetManager.bush1, .8);
    ...
    public Bush1(int x, int y, int rotation) {
        super(x, y);
        this.setScale(VISUAL_SCALE);
        this.setGraphic(bodySprite);
        this.setZLayer(-1);
