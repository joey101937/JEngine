...
public abstract class RTSAssetManager {
    ...
    public static BufferedImage stump2;
    public static BufferedImage stump3;
    ...
    public static BufferedImage reinforcedHullButton;
    ...
    private static final Map<Integer, BufferedImage>   t2GunDamagedMap    = new HashMap<>();
    private static final Map<Integer, BufferedImage>   t2ShieldMap        = new HashMap<>();
    private static final Map<Integer, BufferedImage>   t2ShieldDamagedMap = new HashMap<>();
    ...
    public static void precomputeTeamAssets(Set<Integer> activeTeams) {
        for (int team : activeTeams) {
            ...
            t2GunDamagedMap.put(team,    applyTeamTransform(t2GunDamaged, team));
            t2ShieldMap.put(team,        applyTeamTransform(t2Shield, team));
            t2ShieldDamagedMap.put(team, applyTeamTransform(t2ShieldDamaged, team));
    ...
    public static BufferedImage getT2GunDamaged(int team)    { return t2GunDamagedMap.get(team); }
    public static BufferedImage getT2Shield(int team)        { return t2ShieldMap.get(team); }
    public static BufferedImage getT2ShieldDamaged(int team) { return t2ShieldDamagedMap.get(team); }
    ...
    private static CompletableFuture<Void> loadMapAssets1() {
        return CompletableFuture.runAsync(() -> {
            grassBG = load("DemoAssets/TankGame/" + grassBGFile);
        }, executor);
    }
    ...
    private static CompletableFuture<Void> loadHangarAssets() {
        return CompletableFuture.runAsync(() -> {
            ...
            stump2 = load("DemoAssets/TankGame/buildings/stump2.png");
            stump3 = load("DemoAssets/TankGame/buildings/stump3.png");
            rock1 = load("DemoAssets/TankGame/buildings/rock1.png");
            rock2 = load("DemoAssets/TankGame/buildings/rock2.png");
    ...
    private static CompletableFuture<Void> loadButtonAssets() {
        return CompletableFuture.runAsync(() -> {
            ...
            reinforcedHullButton = load("DemoAssets/TankGame/Buttons/reinforcedHull.png");
